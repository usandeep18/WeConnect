...
const ChatWidget = ({ userId }) => {
  ...
  return (
    <WidgetWrapper>
      ...
      >
        <Typography variant="body1" sx={{ color: main, fontWeight: 600 }}>
          Categories:
        </Typography>
        ...
        {isNonMobileScreens ? (
          <>
            <Button
              variant={
                selectedCategory === "general" ? "contained" : "outlined"
              }
            ...
            <Button
              variant={
                selectedCategory === "technology" ? "contained" : "outlined"
              }
            ...
            <Button
              variant={
                selectedCategory === "science" ? "contained" : "outlined"
              }
          ...
          <>
            <Box sx={{ flexDirection: "row", gap: "5px" }}>
              ...
              <Button
                variant={
                  selectedCategory === "music" ? "contained" : "outlined"
                }
                onClick={() => setSelectedCategory("music")}
              >
                Music
            ...
            return (
              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    backgroundColor:
                      message.userId === userId ? "#C8E6C9" : "#B3E5FC",
                    borderRadius: "8px",
                    padding: "8px 12px",
                    color: "black",
                  }}
                >
                  {message.userId !== userId && `${message.firstName}:`}{" "}
                  {message.message}
      ...
      {socket === null && (
        <Typography variant="body1" sx={{ color: main, marginTop: "10px" }}>
          Please select a category to start chatting.
        </Typography>
      )}
    </WidgetWrapper>
  );
